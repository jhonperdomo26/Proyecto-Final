...
<html lang="es">
    <head>
        ...
        <link href="/css-común/css-footer.css" rel="stylesheet">
    ...
    <footer>
        <div class="footer-content">
          <div class="footer-logo">
            <img src="/multimedia/img/logo.png" alt="logo gimnasio">
          </div>

          <div class="footer-column">
            <ul class="enlaces">
              <li class="enlaces-link">
              ...
              <li class="enlaces-link">
                <a href="/html/clases.html">Clases</a>
              </li>
              <li class="enlaces-link">
                <a href="/html/sobrenosotros.html">Sobre nosotros</a>
              </li>
              <li class="enlaces-link">
                <a href="/html/contactos.html">Contáctanos</a>
              </li>
            </ul>
            <div class="redes">
        ...
        <div class="derechos">
          © 2024 Iron Body. Todos los derechos reservados.
        </div>
